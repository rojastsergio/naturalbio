...
<template>
    <aside 
        :class="[
            ...
            'fixed left-0 top-0 h-full bg-white shadow-lg border-r border-gray-200 transition-all duration-300 ease-in-out z-20 dark:bg-gray-800 dark:border-gray-700'
        ]"
        @mouseenter="isHovered = !isMobile && isCollapsed"
        @mouseleave="isHovered = false"
    >
        <!-- Logo y botón de toggle -->
        <div class="flex items-center justify-between h-16 px-4 bg-naturalbio-verde text-white">
            <div class="flex items-center overflow-hidden">
                ...
                <span 
                    ...
                    class="ml-3 text-xl font-semibold truncate transition-opacity duration-300"
                >
                    NaturalBIO
                </span>
            </div>
